...
<body>
                    ...
                    <div class="col-sm-8 col-4 text-right flex-header-menu justify-content-end">
                        ...
                        <div class="mr-4">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mt-13" aria-labelledby="dropdownMenuLink">
                                ...
                                <div class="dropdown-divider"></div>
                                <button class="dropdown-item" id="logout-button" value="ok"><i class="fa fa-power-off pr-2"></i>Logout</button>
                            </div>
                        </div>
                    </div>
                    <!--Search box and avatar-->
    ...
    <script type="module">
        ...
        const firebaseConfig = {
            apiKey: "AIzaSyDaUaB1jsxll6aEcM2gtkaN9tKqKoBYSrw",
            authDomain: "eshop-c0408.firebaseapp.com",
            databaseURL: "https://eshop-c0408-default-rtdb.firebaseio.com",
            projectId: "eshop-c0408",
            storageBucket: "eshop-c0408.appspot.com",
            messagingSenderId: "715729042074",
            appId: "1:715729042074:web:a5308c8226283b9864bd23",
            measurementId: "G-W07J0TBW8N",
        };
        ...
        logoutButton.addEventListener("click", (e) => {
            ...
            signOut(auth)
                .then(() => {
                    alert("sukses logout");
                    location.href = "http://localhost/scht/index.php";
                })
                .catch((error) => {});
        });
    </script>
